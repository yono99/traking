...
import asdasd from "@/Components/SectionTitle.vue";
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                " :href="route('management.akun')" :active="route().current('management.akun')">
                                    Management Akun
                                </NavLink>
                                <NavLink v-if="
                                ...
                                " :href="route('tanya-genggam.index')" :active="route().current('tanya-genggam.index')
                                    ">
                                    Cari Berkas
                                </NavLink>
                                <NavLink v-if="
